...
#recebe $200 mais 9 por cento de $3000, ou seja, um total
#de $470. Escreva um programa (usando um array de
#contadores) que determine quantos vendedores receberam
...
#lista a partir do salário, sem fazer vários ifs aninhados.